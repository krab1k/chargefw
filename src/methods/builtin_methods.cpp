...
auto make_builtin_methods() -> std::vector<std::unique_ptr<Method>> {
    ...
    methods.push_back(std::make_unique<builtin::SQEMethod>());
    methods.push_back(std::make_unique<builtin::SQEq0Method>());
    methods.push_back(std::make_unique<builtin::SQEqpMethod>());
