...
string(JSON execution_mode GET "${json_output}" calculation_provenance execution mode)
if(NOT execution_mode STREQUAL "full")
    message(FATAL_ERROR "Unexpected effective execution mode: ${execution_mode}")
endif()
string(JSON charge_correction GET "${json_output}" calculation_provenance execution charge_correction)
if(NOT charge_correction STREQUAL "none")
    message(FATAL_ERROR "Unexpected full-execution correction policy: ${charge_correction}")
endif()
string(JSON permissive_types GET "${json_output}" calculation_provenance classification permissive_types)
if(permissive_types)
    message(FATAL_ERROR "Expected strict type classification by default")
endif()
string(JSON full_atom_threshold GET "${json_output}" calculation_provenance resource_policy full_atom_threshold)
